var chan = $('#channels'),
    streamerArr = ["RunForTheMedals", "DTN_DTN_DTN", "Zell_Kozama", "ANakdTurtle", "CutieBuster", "LittleSpaceHead", "ArtBeat", "AleksZiggy", "AnomAnom", "ArlaFett", "Babybearishjew", "BooTricks", "BigJakeBrew", "Breakie101", "CaptainClownCrown", "Capts3xitans3xy", "CornFed_Gaming", "Dclickner10", "DisclaimerGG", "DunkM4sterFlex", "EissMister", "emmahallows", "FarmStandGamez", "Funbob", "Gaymer1977", "GrampaWan", "RedHawkPlays", "HeroForHire", "ImmortalMachine", "JellyFishDisco", "Jhusky18_", "Kickzz", "Kytten_Ninja69", "LunaPod_", "MasterVekk", "M1ch1gander", "MrBevers", "Mushi_Mar", "Nanaki_Face", "Napoj83", "PixieClaire", "professornorington", "Progmozis", "PunishedSnekk", "Roy_Reaper", "RudeIrishKnight", "SheriffYuri", "Shinky", "SmokeyAndYouKnowThis", "StampedePixie", "supermario0004", "SvatFini", "87Sylvz", "Th1nkman", "ThrasherDoo", "TheTibbers", "TMX85", "TundraColt", "Twicker", "WanHedaGames", "wildride", "Xayvay", "Yohnicus", "Zevonna", "ItsZod4", "ZombieDecoy", "Zyphexian", "Xmooshie", "acesxtv", "cometgirl2222", "ladyboomin"];
